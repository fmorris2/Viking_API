...
/**
 * Created by Sphiinx on 1/23/2017.
 */
public enum MiningLocation {
    ...
    }), false, false, 20, 13, RockType.CLAY, RockType.TIN_ORE, RockType.IRON_ORE),
    ...
    }), false, false, 20, 13, RockType.TIN_ORE, RockType.COPPER_ORE, RockType.IRON_ORE),
    ...
    }), false, false, 10, -1, RockType.TIN_ORE, RockType.COAL),
    ...
    }), false, false, 40, -1, RockType.CLAY, RockType.TIN_ORE, RockType.COPPER_ORE, RockType.IRON_ORE, RockType.GOLD),
    ...
    ), false, false, 20, -1, RockType.COPPER_ORE, RockType.TIN_ORE),
    ...
    }), false, false, 20, -1, RockType.COAL, RockType.MITHRIL, RockType.ADAMANTITE),
    ...
    }), false, false, 40, 29, RockType.COPPER_ORE, RockType.TIN_ORE, RockType.SILVER_ORE, RockType.IRON_ORE, RockType.COAL, RockType.GOLD, RockType.MITHRIL, RockType.ADAMANTITE);
    ...
    MiningLocation(Area area, boolean members, boolean should_use_deposit_box, int capacity, int recommended_combat_level, RockType... rock_type) {
        this.AREA = area;
