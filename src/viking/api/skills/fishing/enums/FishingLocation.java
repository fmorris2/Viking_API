...
public enum FishingLocation {
    ...
    F_LUMBRIDGE_SOUTH_1(new Area(new int[][]{
            ...
            {3233, 3138},
            {3243, 3162}
    }), false, false, FishType.SHRIMP, FishType.SARDINE, FishType.HERRING, FishType.ANCHOVIES),
    ...
    F_LUMBRIDGE_NORTH_1(new Area(new int[][]{
            ...
            {3242, 3259},
            {3231, 3259}
    }), false, false, FishType.PIKE, FishType.SALMON, FishType.TROUT),
    ...
    F_KARAMJA_1(new Area(new int[][]{
            ...
            {2936, 3165},
            {2909, 3177}
    }), false, true, FishType.SHRIMP, FishType.SARDINE, FishType.HERRING, FishType.ANCHOVIES, FishType.TUNA, FishType.LOBSTER, FishType.SWORDFISH),
    F_MUDSKIPPER_POINT_1(new Area(new int[][]{
            {2976, 3180},
            {2991, 3186},
            {3004, 3158},
            {2991, 3148}
    }), false, true, FishType.SHRIMP, FishType.SARDINE, FishType.HERRING, FishType.ANCHOVIES);
    ...
    FishingLocation(Area area, boolean members, boolean use_deposit_box, FishType... tree_type) {
        this.AREA = area;
